namespace Monzo.Tests.MonzoClientTests
{
    ...
    public sealed class Attachements
    {
        ...
        public async Task CanCreateAttachment()
        {
            var (httpClient, fakeMessageHandler) = FakeHttpClientFactory.Create(HttpStatusCode.OK,
                ...
                using (var client = new MonzoClient(httpClient, "testAccessToken"))
                {
                    ...
                    ClassicAssert.AreEqual("attach_00009238aOAIvVqfb9LrZh", attachment.Id);
                    ClassicAssert.AreEqual("user_00009238aMBIIrS5Rdncq9", attachment.UserId);
                    ClassicAssert.AreEqual("tx_00008zIcpb1TB4yeIFXMzx", attachment.ExternalId);
                    ClassicAssert.AreEqual("https://s3-eu-west-1.amazonaws.com/mondo-image-uploads/user_00009237hliZellUicKuG1/LcCu4ogv1xW28OCcvOTL-foo.png", attachment.FileUrl);
                    ClassicAssert.AreEqual("image/png", attachment.FileType);
                    ClassicAssert.AreEqual(new DateTime(2015, 11, 12, 18, 37, 2, DateTimeKind.Utc), attachment.Created);
                }

                ClassicAssert.AreEqual("/attachment/register", fakeMessageHandler.Request.RequestUri.PathAndQuery);
                ...
                ClassicAssert.AreEqual("tx_00008zIcpb1TB4yeIFXMzx", formCollection["external_id"]);
                ClassicAssert.AreEqual("image/png", formCollection["file_type"]);
                ClassicAssert.AreEqual("https://s3-eu-west-1.amazonaws.com/mondo-image-uploads/user_00009237hliZellUicKuG1/LcCu4ogv1xW28OCcvOTL-foo.png", formCollection["file_url"]);
        }
        ...
        public async Task CanDeleteAttachment()
        {
            ...
            ClassicAssert.AreEqual("/attachment/deregister", fakeMessageHandler.Request.RequestUri.PathAndQuery);
            ClassicAssert.AreEqual("POST", fakeMessageHandler.Request.Method.ToString());
            ...
            ClassicAssert.AreEqual("attach_00009238aOAIvVqfb9LrZh", formCollection["id"]);
        }
    }
}
